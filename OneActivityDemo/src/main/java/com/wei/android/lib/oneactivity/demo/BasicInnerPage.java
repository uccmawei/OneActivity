...
import com.wei.android.lib.oneactivity.LibInnerPage;
import com.wei.android.lib.oneactivity.OnFinishListener;
import com.wei.android.lib.oneactivity.PageActivity;

public abstract class BasicInnerPage extends LibInnerPage {

    protected BasicInnerPage(PageActivity pageActivity) {
        super(pageActivity);
    }
